    ...
    if request.method == 'POST':
        ...
        if user and bcrypt.check_password_hash(user.password, password):
            ...
            if user.is_lecturer==True:
                return redirect(url_for('lecturerforum')) #will fill in this later with my friend's html link
            else :
                return redirect(url_for('studentforum')) #will fill in this later with my friend's html link
        else:
